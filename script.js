document.addEventListener('DOMContentLoaded', () => {
  ...
  const selectorTranslations = {
    en: {
      ...
      ".project-card:nth-child(3) .project-title": "Certificate Verifier",
      ".project-card:nth-child(3) .project-desc": "Online certificate verification platform that validates credentials and generates unique verification IDs.",
      ".project-card:nth-child(4) .project-title": "All-in-One Tools Hub",
      ".project-card:nth-child(4) .project-desc": "A comprehensive web tools collection comprising developer widgets, math solvers, and productivity modules.",
      ".project-card:nth-child(5) .project-title": "CV Builder Platform",
      ".project-card:nth-child(5) .project-desc": "Professional resume builder with downloadable templates, custom fields, and real-time frosted glass previews.",
    ...
    kh: {
      ...
      ".project-card:nth-child(3) .project-title": "អ្នកផ្ទៀងផ្ទាត់វិញ្ញាបនបត្រ",
      ".project-card:nth-child(3) .project-desc": "វេទិកាផ្ទៀងផ្ទាត់វិញ្ញាបនបត្រអនឡាញ ដែលបញ្ជាក់សុពលភាពលិខិតសម្គាល់ និងបង្កើតលេខសម្គាល់ផ្ទៀងផ្ទាត់តែមួយគត់។",
      ".project-card:nth-child(4) .project-title": "មជ្ឈមណ្ឌលឧបករណ៍ All-in-One",
      ".project-card:nth-child(4) .project-desc": "ការប្រមូលផ្តុំឧបករណ៍គេហទំព័រដ៏ទូលំទូលាយ រួមមាន ធាតុក្រាហ្វិកអ្នកអភិវឌ្ឍន៍ អ្នកដោះស្រាយគណិតវិទ្យា និងម៉ូឌុលផលិតភាព។",
      ".project-card:nth-child(5) .project-title": "វេទិកាបង្កើត CV",
      ".project-card:nth-child(5) .project-desc": "អ្នកបង្កើតប្រវត្តិរូបសង្ខេបអាជីព ជាមួយគំរូដែលអាចទាញយកបាន វាលផ្ទាល់ខ្លួន និងការមើលជាមុនកញ្ចក់ថ្លាក្នុងពេលជាក់ស្តែង។",
  ...
  function applyLanguage(lang) {
    ...
    // 4. "Under Developer" text on project cards
    document.querySelectorAll('.project-btn span').forEach(el => {
  ...
  // --- Project Button Under Developer Toast ---
  ...
  function openCybertoolsWindow() {
    ...
    // Lazy load iframe source if it isn't set yet
